...
public class Messages {
	...
	public static final String ERR_CANNOT_DELETE_USER = "Cannot delete an user from the database";

	// Bill
	public static final String ERR_CANNOT_GET_LIST_OF_BILLS = "Cannot get a list of bills from database";
	public static final String ERR_CANNOT_GET_BILL = "Cannot get a bill from the database";
	public static final String ERR_CANNOT_INSERT_BILL = "Cannot insert a bill to the database";
	public static final String ERR_CANNOT_UPDATE_BILL_STATUS = "Cannot update a bill's status in the database";
	public static final String ERR_CANNOT_DELETE_BILL = "Cannot delete a bill from the database";
	...
	public static final String ERR_CANNOT_DELETE_RATE = "Cannot delete a rate from the database";
	...
	public static final String ERR_CANNOT_GET_ORDER = "Cannot get an order from the database";
	public static final String ERR_CANNOT_DELETE_ORDER = "Cannot delete an order from the database";

	// Direction
	public static final String ERR_CANNOT_GET_LIST_OF_DIRECTIONS = "Cannot get a list of directions from the database";
	public static final String ERR_CANNOT_GET_DIRECTION = "Cannot get a direction from the database";
	...
	public static final String EER_CANNOT_COMMIT_AND_CLOSE_TRANSACTION = "Cannot commit and close transaction";
	public static final String EER_CANNOT_ROLLBACK_AND_CLOSE_TRANSACTION = "Cannot rollback and close transaction";
}
